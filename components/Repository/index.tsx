...
import { Container, Header, Title, Description, Languages, ContainerLanguage, Language, LanguageDetail, LoadingLanguage, Options, Option, IconOption, ContainerThumbnail, Thumbnail, Markdown, ContainerCopyMarkdown, ButtonCopyMarkdown, IconCopyMarkdown } from './style'
                    ...
                    <Markdown
                        ...
                        components={{
                            pre: props => {
                                ...
                                return (
                                    <ContainerCopyMarkdown>
                                        <ButtonCopyMarkdown onClick={handleClick}>
                                            <IconCopyMarkdown xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
